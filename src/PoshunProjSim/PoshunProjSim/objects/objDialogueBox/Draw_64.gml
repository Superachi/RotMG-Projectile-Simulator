...
draw_set_alpha(0.4);
draw_rectangle(_x - _w div 2, _y + _windowTopH, _x + _w div 2, _y + _windowTopH + _h + 8, false);
...
drawTextCustom(boxText,  _x, _y + _windowTopH + 16, fnt_default, c_white, fa_center, fa_top, 1, 16, _w - 16);