...
function bulletAction() constructor {
	// General
	lifeTime	= getParamDefaults(ParamTypes.projLifetime).paramDefault;
	projSpeed	= getParamDefaults(ParamTypes.projSpeed).paramDefault;
	projDir		= 0;
...
function bulletCreate(_actionStruct, _visualStruct) {
	...
	with(o) {
		...
		// Turning
		turnDelay		= _actionStruct.turnDelay;
		turnRate		= _actionStruct.turnRate;
